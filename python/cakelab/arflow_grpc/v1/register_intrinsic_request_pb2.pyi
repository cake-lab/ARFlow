...
class RegisterIntrinsicsRequest(_message.Message):
    __slots__ = ("session_id", "device", "device_timestamp", "intrinsics")
    ...
    def __init__(self, session_id: _Optional[_Union[_session_pb2.SessionUuid, _Mapping]] = ..., device: _Optional[_Union[_device_pb2.Device, _Mapping]] = ..., device_timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., intrinsics: _Optional[_Union[_intrinsics_pb2.Intrinsics, _Mapping]] = ...) -> None: ...
