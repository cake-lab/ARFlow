...
class SynchronizedARFrame(_message.Message):
    __slots__ = ("device_timestamp", "transform_frame", "color_frame", "depth_frame", "gyroscope_frame", "audio_frame", "plane_detection_frame", "point_cloud_detection_frame", "mesh_detection_frame")
