...
class ColorFrame(_message.Message):
    __slots__ = ("device_timestamp", "image")
    ...
    def __init__(self, device_timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., image: _Optional[_Union[_xr_cpu_image_pb2.XRCpuImage, _Mapping]] = ...) -> None: ...
