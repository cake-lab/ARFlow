...
namespace ARFlow
{
    ...
    public class ARFlowClient
    {
        ...
        private readonly ARFlow.ARFlowClient _client;
        ...
        public ARFlowClient(string address)
        {
            ...
            _client = new ARFlow.ARFlowClient(_channel);
        }
        ...
        public void Connect(ClientConfiguration requestData)
        {
            try
            {
        ...
        public string SendFrame(DataFrame frameData)
        {
            string res = "";
