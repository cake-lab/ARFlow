...
namespace CakeLab.ARFlow.DataModalityUIConfig
{
    public class PoseUIConfig : BaseDataModalityUIConfig
    {
        ...
        private const string DESC = "Buffer for storing pose data of the current device, relative to the ArUco marker if synced.";
        ...
        public PoseUIConfig(Transform objTransform, IClock clock, bool isBufferAvailable = true)
        {
        ...
        public override void InitializeConfig(GameObject parent, DataModalityUIConfigPrefabs prefabs, Action<bool> onToggleModality)
        {
            ...
            GameObject bufferDesc = GameObject.Instantiate(prefabs.bodyTextPrefab, parent.transform);
            bufferDesc.GetComponent<Text>().text = DESC;
        ...
        public PoseBuffer GetBufferFromConfig()
        {
            ...
            return new PoseBuffer(int.Parse(bufferSizeField.text), m_ObjTransform, m_Clock, int.Parse(samplingIntervalField.text));
        }
