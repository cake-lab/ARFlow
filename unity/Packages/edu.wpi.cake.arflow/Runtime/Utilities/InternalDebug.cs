...
{
    /// <summary>
    /// Provides a set of debug utilities that are conditionally compiled based on the build configuration.
    /// </summary>
    /// <remarks>
    /// Vendored from <a href="https://github.com/JoebRogers/UnityDebug/blob/master/src/InternalDebug.cs">UnityDebug</a>.
    /// See their README for why we're using this instead of Unity's Debug class.
    /// </remarks>
