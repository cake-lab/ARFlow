...
namespace CakeLab.ARFlow.DataModalityUIConfig
{
    public class PlaneDetectionUIConfig : IDataModalityUIConfig
    {
        ...
        public PlaneDetectionUIConfig(GameObject parent, DataModalityUIConfigPrefabs prefabs, Action<bool> onToggleModality, bool isBufferAvailable = false)
        {
            //Name
        ...
        public PlaneDetectionBuffer getBufferFromConfig(ARPlaneManager manager)
        {
            return new PlaneDetectionBuffer(int.Parse(bufferSizeField.text), manager);
        }
